...
(function () {
  ...
  // Fires on normal loads AND on back/forward-cache restores. Without this,
  // a page brought back from bfcache can still carry the "page-leave" class
  // from when the user navigated away, leaving the whole app (nav included)
  // invisible and unclickable even though it's technically on screen.
  ...
  window.addEventListener("pageshow", (e) => {
    if (e.persisted) resetOnPageShow();
  });
